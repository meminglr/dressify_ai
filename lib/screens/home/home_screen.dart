  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: BottomBar(
        ...
        barColor: AppColors.surfaceContainerLowest.withAlpha(200),
        ...
        body: (context, controller) => TabBarView(
          ...
          children: [
            ...
            _buildPlaceholderContent('Explore'),
            _buildPlaceholderContent('Wardrobe'),
            _buildPlaceholderContent('Profile'),
          ],
        ),
        child: Container(
      ...
      floatingActionButton: Padding(
        padding: const EdgeInsets.only(bottom: 80.0), // Above the bottom bar
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: CircleAvatar(
                    ...
                    radius: 24,
                    child: const Icon(Iconsax.logout, color: AppColors.primary, size: 20),
                  ),
                ),
              ],
            ),
